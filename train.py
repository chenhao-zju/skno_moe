...
from utils.data_loader_npyfiles import get_data_loader_npy
...
class Trainer():
    ...
    def __init__(self, params, world_rank):
        ...
        self.model = SKNO(params).to(self.device)
    ...
    def loss_obj(self, pred1, pred2, target1, target2, weight1=0.8, weight2=0.2):
    ...
    def validate_one_epoch(self):
        ...
        with torch.no_grad():
            for i, data in enumerate(self.valid_data_loader):
                ...
                valid_weighted_rmse += weighted_rmse_torch(gen-climate, tar-climate)
        ...
        # logging.info(f" RMSE of Z500: {valid_weighted_rmse_cpu[5]}, T2m: {valid_weighted_rmse_cpu[-3]}, T850: {valid_weighted_rmse_cpu[54]}, U10: {valid_weighted_rmse_cpu[-2]}")
...
if __name__ == '__main__':
  ...
  parser.add_argument("--yaml_config", default='./config/SKNO.yaml', type=str)
...
#  params['group'] = "era5_wind" + args.config
  params['name'] = args.config + '_' + str(args.run_num)
  params['group'] = "13296648985-Zhejiang University"
  params['project'] = "skno"
